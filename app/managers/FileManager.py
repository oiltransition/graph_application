...
class FileManager:
    ...
    def __init__(self):
        # Creating the path for saving results
    ...
    def __get_filename_from_variable_name(self, variable_name, extension = ".csv"):
        return variable_name.lower().replace(" ","_")+extension

    def save_dataframe_to_csv(self, df, variable_name):
        filename = self.__get_filename_from_variable_name(variable_name)
